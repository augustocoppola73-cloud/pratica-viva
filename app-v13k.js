...
function recordDaimokuSession(minutes) {
    ...
    stats.todayMinutes =
        Number(stats.todayMinutes || 0) + minutesToAdd;

    stats.daily[today] =
        Number(stats.daily[today] || 0) + minutesToAdd;
    ...
    if (stats.lastDate === today) {
        ...
        stats.lastDate &&
        daysBetween(stats.lastDate, today) === 1
    ) {

        stats.streak =
            Number(stats.streak || 0) + 1;

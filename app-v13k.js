...
function renderPracticeAssistant(){
  ...
  const todayMinutes = Number(s.todayMinutes || 0);
...
function initApp(){
  ...
  if(targetInput){
    ...
    targetInput.addEventListener('input', refreshTarget);
    targetInput.addEventListener('change', refreshTarget);
    targetInput.addEventListener('blur', refreshTarget);
  }
updateDailyBadge();
}

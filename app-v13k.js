...
const goalKey = 'pv12GoalMinutes';

function getGoal(){
  return Number(localStorage.getItem(goalKey) || 60); // default 60 min
}
...
function getProgressPercentage(){
  ...
  const goal = getGoal();
  if(goal <= 0) return 0;
  return Math.min(100, Math.round((stats.minutes / goal) * 100));
}
...
function renderStats(){
  ...
  statsBox.innerHTML = `
    ...
    <div class="progress-container">
      <div class="progress-label">Obiettivo: ${goal} min</div>
